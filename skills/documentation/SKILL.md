...
定稿时逐句检查含“不、无、未、禁止、避免、排除、无需、不得”等否定标记的内容。保留安全 / 授权 / 隐私 / 合规红线、真实负向行为契约、影响结论的证据缺口，以及一处带具体原因的淘汰路线；其余句子改写为目标状态、纳入范围、选定动作或正向验收标准，改写后仍无新增信息则删除。
...
- 范围由一个权威位置的纳入项和必要约束闭合，后续章节没有重复排除清单；当前路线是正文主体，同一淘汰路线只在其原因有决策价值时于决策依据处出现一次；每项内容都提供事实、决定、原因或行动信息，空栏目已省略。
